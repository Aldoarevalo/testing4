...
function borrarFila() {
    ...
    <body id="hhmenu">
     ...
     <ul id="hmenu"> 
        ...
        <form id="getactionorden" name="getactionorden" method="post" action="insertetapa.php">
...
<select id="cboestado"  name="combosucursaletapa" > 
    ...
    <div >
        <label style="top:280px;position: absolute;" >Fecha: <input name="fecha" readonly="false" type="text" id="datepicker">&nbsp;<input type="text" id="alternate" size="30" readonly="false"/></label>
...
<option >TIPO RESTAURANTE</option>
         ...
         <label style="position:absolute;top:345px;margin-left:430px;">Buscar Cliente:</label>                  
     ...
     <?php echo $producto; ?>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="crear_etapa" id="crear_etapa" class="btn btn-info" value="Gravar" />
                </td>
