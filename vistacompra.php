        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["id_compra"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigoproducto" id="codigoproducto <?php echo $m; ?>" value="<?php echo $row["id_compra"]; ?>" />
...
$statement = $connect->prepare("
        ...
        foreach($result as $row){
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>ID :</b>
                        <b>  </b><b><?php echo $row['id_compra']; ?></b><br />
                       
                    </div>
                                    
                    <div class="col-md-8">
                     <br /> <b>Emresa :</b>
                        <b>  </b><b>Alimentos y Servicios Srl</b><br />
                      
                      
                    </div>
                                        <div class="col-md-8">
                     <br /> <b>Comprobante NR:</b>
...
<!--                      <td width="40%" ><?php echo $sub_row["nombre"]; ?></td>-->
...
<!--                                        <tr>
					...
					<td colspan="2"><strong style="font-size: 12px;"><?php //  echo $sub_row["codigoproducto"]; ?>
					</strong></td>
                                        </tr>-->
