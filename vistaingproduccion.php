...
<body id="hhmenu">
	...
	<li class=""><a href="Registrar Transferencia.jsp">Registrar Peido de Compras</a></li>
		<li><?php
					$ordenp=$_GET['ingreso'];
include('database_connection.php');
$statement = $connect->prepare("
          SELECT * FROM vistaingproduccion
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["idIngreso"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigoproducto" id="codigoproducto <?php echo $m; ?>" value="<?php echo $row["idorden"]; ?>" />
      ...
      <h3  ><a style="color: black;" href="Transferencias.jsp">Informes de Movimientos de Ordene</a></h3>    
...
$statement = $connect->prepare("
        ...
        foreach($result as $row){
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>ID :</b>
                        <b>  </b><b><?php echo $row['idIngreso']; ?></b><br />
                       
                    </div>
                                    
                    <div class="col-md-8">
                     <br /> <b>Orden de Produccion Numero :</b>
                        <b>  </b><b><?php echo $row['idorden']; ?></b><br />
                      
                      
                    </div>
                                    <div class="col-md-8">
                      <br /> <b>Centro de Produccion :</b>
                        <b>  </b><b><?php echo $row['centrodeproduccion']; ?></b><br />
                      
                    </div>
                                        <div class="col-md-8">
                      <br /> <b>Almacen de Ingreso:</b>
                        <b>  </b><b><?php echo $row['almacendestino']; ?></b><br />
                      
                    </div>
                                     <div class="col-md-8">
                      <br /> <b>Persona a Cargo:</b>
                        <b>  </b><b><?php echo $row['PersonaAcargo']; ?></b><br />
                      
                    </div>
                                     
                                                            <div  class="col-md-8">
                      <br /> <b>Fecha de Ingreso:</b>
...
<!--                                                            <div  class="col-md-8">
                      <br /> <b>Usuario :</b>
                        <b>  </b><b><?php echo $row['cliente']; ?></b><br />
	...
	<table border="2" cellpadding="1" rules="all" style="font-family: arial; font-size: 13px;	text-align:left;" width="100%">
		<thead >
			<tr >
				...
				<th>Costos de Ingresos</th>
                                <th>Costo Total de Ingreso</th>
			</tr>
		</thead>
...
$statement = $connect->prepare("
        ...
        $item_result = $statement->fetchAll();
				...
				<tr style="font-family:arial; font-size:15px;"  >
                      ...
                      <td><?php echo $sub_row["precio"]; ?></td>
                       <td><?php echo $sub_row["nombres"]; ?></td>
                      <td><?php echo $sub_row["Cantidadingresada"]; ?></td>
    ...
    <div style="width: 120%; margin-top:30px;">
        <b>Costos de Orden</b>
	<table border="2" cellpadding="1" rules="all" style="font-family: arial; font-size: 13px;	text-align:left;" width="100%">
		<thead >
			<tr >
...
$statement = $connect->prepare("
        ...
        $item_result = $statement->fetchAll();
				...
				<tr style="font-family:arial; font-size:15px;"  >
                      ...
                      <td><?php echo $sub_row["precio"]; ?></td>
                       <td><?php echo $sub_row["nombres"]; ?></td>
                      <td><?php echo $sub_row["cantidad"]; ?></td>
                      <td><?php echo $sub_row["total"];?></td>
...
<!--                        <b>  </b><b><?php echo $row['cliente']; ?></b><br />-->
    ...
    <div style="margin-left: 500px;">
                      <br /> <b>Registro :</b>
<!--                        <b>  </b><b><?php echo $row['fechaelaboracion']; ?></b><br />-->
