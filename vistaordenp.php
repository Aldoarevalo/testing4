        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["idorden"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
                    ...
                    <div class="col-md-8">
                     <br /> <b>Centro de Produccion :</b>
                        <b>  </b><b><?php echo $row['centrodeproduccion']; ?></b><br />
                                    ...
                                    <div class="col-md-8">
                      <br /> <b>Tipo de Produccion :</b>
                        <b>  </b><b><?php echo $row['tipoproduccion']; ?></b><br />
                      
                    </div>
                                        <div class="col-md-8">
                      <br /> <b>Fecha de Elaboracion:</b>
                        <b>  </b><b><?php echo $row['fechaelaboracion']; ?></b><br />
                      
                    </div>
                                     <div class="col-md-8">
                      <br /> <b>Fecha de Entrega:</b>
                        <b>  </b><b><?php echo $row['fechaentrega']; ?></b><br />
                      
                    </div>
                                     
                                                            <div  class="col-md-8">
                      <br /> <b>Persona a cargo :</b>
                        <b>  </b><b><?php echo $row['empleado']; ?></b><br />
                      
                    </div>
                  
                                                            <div  class="col-md-8">
                      <br /> <b>Platilla utilizada :</b>
                        <b>  </b><b><?php echo $row['plantilla']; ?></b><br />
