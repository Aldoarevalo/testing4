        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["idPedidoCompra"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigoproducto" id="codigoproducto <?php echo $m; ?>" value="<?php echo $row["idPedidoCompra"]; ?>" />
...
$statement = $connect->prepare("
        ...
        foreach($result as $row){
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>ID :</b>
                        <b>  </b><b><?php echo $row['idPedidoCompra']; ?></b><br />
                    ...
                    $m = 0;
          {
            echo '
              <tr>
                ...
                <td><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$sub_row["idPedidoCompra"].'"><span class="glyphicon glyphicon-edit">Editar</span></a></td>
...
<div style="margin-left: 500px;">
                      <br /> <b>usuario :</b>
                        <b>  </b><b><?php echo $sub_row['cliente']; ?></b><br />
