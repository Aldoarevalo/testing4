...
<!--		     <li>		<a  href="javascript:Clickheretoprint()" style="font-size:20px;"><button  class="btn btn-success btn-large"><i class="icon-print"></i> Imprimir</button></a></li>-->
       ...
       <h3><a style="color: black" href="MantenerSubRubro.php"></a>Bancos</h3>
     
        <form id="getaction">
            
            <h4><a style="color: black;text-decoration: none;" >Bancos</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionbanco.php", //Request send to "action.php page"
