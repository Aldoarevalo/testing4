...
<body id="hhmenu">
  ...
  <div id="header">
         ...
         <form method="post"action="actionbanco.php">
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                           ...
                           <td style="margin-left:100px;"><a href="EditarBanco.php?updatep=1&banco='.$row["idcuentabanco"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="idcuentabanco" id="idcuentabanco <?php echo $m; ?>" value="<?php echo $row["idcuentabanco"]; ?>" />
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>Id :</b>
                        ...
                        <b>  </b><b ><?php echo $row['idcuentabanco']; ?></b><br />
                        
                    </div>
                                    
                    <div class="col-md-8">
                     <br /> <b>Banco :</b>
                        <b>  </b><b><?php echo $row['CuentaBanco']; ?></b><br />
                      
                      
                    </div>
                       <div class="col-md-8">
                     <br /> <b>Número SIPAP :</b>
                        <b>  </b><b><?php echo $row['NumeroSipap']; ?></b><br />
