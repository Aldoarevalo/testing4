...
/*                                font-weight:  bold;*/
    ...
    <body id="hhmenu">
      ...
      <div id="header">
		...
		<li><a href="MantenerRubro.php">Mantener Banco</a></li>
         ...
         <h3 id="h6" style="color: black">Crear Banco</h3>    
         <form method="post" action="actionbanco.php" id="getmoneda">
                 <h4 id="h1" style="color: black">Crear Banco</h4>
             ...
             <div>
                ...
                <input type="hidden" name="accion" value="grabarproveedor" />
                  ...
                  <label id="labelsimbolo">Nombre de Cuenta O Banco</label>
                   <input style="text-decoration-color:blue;" id="txtsimbolo"type="text" name="txtbanco" value=""  placeholder="Ingrese un Nombre Para el Banco" />
                     <label id="labelprecioventa">Numero de Sipap</label>
                     <input id="txtprecioventa" type="text" name="txtsipap" value=""  placeholder="Ingrese un Numero de sipap para el banco" />
...
<!--        </select>
         ...
         <input style="margin-left: 50px" name="crearbanco" id="gravarprod" type="submit" value="Grabar"  class="btn btn-info" />
