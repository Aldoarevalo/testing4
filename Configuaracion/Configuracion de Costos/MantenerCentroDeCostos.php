...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
	   ...
	   <li><a href="CrearCentroDeCosto.php">Crear Centro de Costo</a></li>
...
<!--		     <li>		<a  href="javascript:Clickheretoprint()" style="font-size:20px;"><button  class="btn btn-success btn-large"><i class="icon-print"></i> Imprimir</button></a></li>-->
       ...
       <h3><a style="color: black" href="MantenerSubRubro.php"></a>Cetro de Costos</h3>
     
        <form id="getaction">
            
            <h4><a style="color: black;text-decoration: none;" >Centros de Costos</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actioncentrocosto.php", //Request send to "action.php page"
