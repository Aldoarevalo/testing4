...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
	   ...
	   <li><a href="CrearRubro.php">Crear Rubro</a></li>
       ...
       <h3><a style="color: black" href="MantenerRubro.php"></a></h3>
     
        <form id="getaction">
            
            <h4><a style="color: black;text-decoration: none;" >Rubros</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionrubro.php", //Request send to "action.php page"
