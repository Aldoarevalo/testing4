...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
		...
		<li><a href="CrearCategoriaDeProductos.php">Crear Categoria de Producto</a></li>
		
	
	
</div>
       <h3 style="color: black">Categoria de Productos</h3>
     
        <form id="getaction">
            
            <h4 style="color: black">Categoria de Productos</h4>
...
<!-- Filtrar <input id="searchTerm" type="text" onkeyup="doSearch()" />-->
 ...
 <div class="content" id="content">  
     <table id="Tabla1"border="1"cellspacing="0"cellpading="0"rules="all"class="table table-bordered table-striped">
      ...
      </div><li>		<a  href="javascript:Clickheretoprint()" style="font-size:20px;"><button  class="btn btn-success btn-large"><i class="icon-print"></i> Imprimir</button></a></li>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actioncategoria.php", //Request send to "action.php page"
