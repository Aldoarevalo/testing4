        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                           ...
                           <td style="margin-left:100px;"><a href="EditarCategoria.php?updatep=1&categoria='.$row["idcategoria"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="idcategoria" id="idcategoria <?php echo $m; ?>" value="<?php echo $row["idcategoria"]; ?>" />
...
<?php
					$categoria=$_GET['categoria'];
include('../../database_connection.php');
$statement = $connect->prepare(" SELECT ca.idcategoria,ca.nombrecategoria,ca.usuario,sr.subrubro FROM subrubros sr,categoriadeproductos ca
     WHERE ca.codigosubrubro=sr.codigosubrubro  and idcategoria=:categoria
            LIMIT 1
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>Codigo :</b>
                        ...
                        <b>  </b><b ><?php echo $row['idcategoria']; ?></b><br />
