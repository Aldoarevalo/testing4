...
<body id="hhmenu">
  ...
  <div id="header">
         ...
         <form method="post"action="actionrubro.php">
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                           ...
                           <td style="margin-left:100px;"><a href="EditarRubro.php?updatep=1&rubro='.$row["codigorubro"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigorubro" id="codigorubro <?php echo $m; ?>" value="<?php echo $row["codigorubro"]; ?>" />
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>Id :</b>
                        ...
                        <b>  </b><b ><?php echo $row['codigorubro']; ?></b><br />
