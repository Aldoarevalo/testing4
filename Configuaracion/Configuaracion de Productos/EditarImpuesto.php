...
/*                                font-weight:  bold;*/
  ...
  <?php
      ...
      elseif(isset($_GET["updatep"]) && isset($_GET["impuesto"]))
      {
...
<!--                <input type="hidden" name="accion" value="grabarimpuesto" />-->
                ...
                <label id="labelgeneral">Nombre</label>
                 <input id="txtnombremoneda" type="text" name="txtnombre" value="<?php echo $row["nombre"]; ?>" />
                  <label id="labelgeneral">Tasa</label>
                   <input id="txtsimbolo"type="text" name="txttasa" value="<?php echo $row["tasa"]; ?>" />
                     <label id="labelgeneral">Aplicar Ventas</label>
                     <input id="txtprecioventa" type="text" name="txtaplicarventas" value="<?php echo $row["aplicarventas"]; ?>" />
                       <label id="labelgeneral">Aplicar Compras</label>
                         <input id="txtpreciocompra" type="text" name="txtaplicarcompras" value="<?php echo $row["aplicarcompras"]; ?>" />
                         <input type="hidden" name="idimpuesto" id="idimpuesto <?php echo $m; ?>" value="<?php echo $row["idimpuesto"]; ?>" />
                            <input id="gravarimpuesto" type="submit" value="Grabar" name="updateimpuesto" />
