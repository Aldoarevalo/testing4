...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
	   ...
	   <li><a href="CrearMarca.php">Crear Marca</a></li>
       ...
       <h3><a style="color: black" href="Transferencias.jsp"></a></h3>
     
        <form id="getaction">
            
            <h4><a style="color: black;text-decoration: none;" >Marcas</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionmarca.php", //Request send to "action.php page"
