...
<body id="hhmenu">
  ...
  <div id="header">
         ...
         <form method="post"action="actionmarca.php">
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                           ...
                           <td style="margin-left:100px;"><a href="EditarMarca.php?updatep=1&marca='.$row["idmarca"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="idmarca" id="idmarca <?php echo $m; ?>" value="<?php echo $row["idmarca"]; ?>" />
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>Id :</b>
                        ...
                        <b>  </b><b ><?php echo $row['idmarca']; ?></b><br />
