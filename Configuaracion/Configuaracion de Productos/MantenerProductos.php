...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
		...
		<li><a href="mantener1.php">Listar Productos</a></li>
		<li><a href="#">Lista Formulada</a></li>
		...
		<li><a href="registrar.php?update1=1&idPedidoCompra='.$row["idPedidoCompra"].'"><span class="glyphicon glyphicon-edit"></span></a></li>
		
	
	
</div>
       <h3><a style="color: black" href="Transferencias.jsp">Productos</a></h3>
