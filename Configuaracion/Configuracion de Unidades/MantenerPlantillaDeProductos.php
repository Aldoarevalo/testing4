...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
		...
		<li><a href="CrearPlantilla.php">Crear Plantilla</a></li>
       ...
       <h3><a style="color: black" href="Transferencias.jsp">Plantilla</a></h3>
     
        <form id="getaction">
            
            <h4><a style="color: black" href="Reportes de Compras.jsp">Plantillas</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionplantilla.php", //Request send to "action.php page"
