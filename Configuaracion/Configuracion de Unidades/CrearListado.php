...
<html>
       <head>
        ...
        <a href=></a>
     <title>Crear Listado de Precio de Proveedor</title>
    <meta charset="utf-8">
...
//});
    ...
    <body id="hhmenu">
     ...
     <ul id="hmenu"> 
		...
		<li><a href="MantenerListadoDePrecioDeProveedor.php">Mantener Listado de Precio de Proveedor</a></li>
		
	
</div>
        
        
            <h3  ><a style="color: black;" href="Transferencias.jsp">Crear Listado de Precio</a></h3>    
...
<!--                      <th><button type="button" name="add_row" id="add_row" class="btn btn-success btn-sm add"><span class="glyphicon glyphicon-plus"></span></button></th>-->
  ...
  <select   name="producto" id="producto"  class="form-control action selectpicker "  data-live-search="true" title="Buscar Productos Para la Plantilla ...">
     ...
     <?php echo $producto; ?>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="crear_lista" id="crear_lista" class="btn btn-info" value="Gravar" />
                </td>
...
//          html_code += '<td><input type="text" name="order_item_final_amount[]" id="order_item_final_amount'+count+'" data-srno="'+count+'" readonly class="form-control input-sm order_item_final_amount" /></td>';
            html_code += '<td><input type="text" style=" width:0px; height: 0px;background-color:white;margin-left:0px;" value="'+nombres+'" name="al[]" id="al'+count+'" data-srno="'+count+'" /></td>';
