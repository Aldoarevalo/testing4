...
<html>
    <head>
        ...
        <title>Listado de Precio de Proveedores</title>
...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
		...
		<li><a href="CrearListado.php">Crear Listado</a></li>
       ...
       <h3><a style="color: black" href="Transferencias.jsp">Listado de Precio de Proveedores</a></h3>
     
        <form id="getaction">
            
            <h4><a style="color: black" href="Reportes de Compras.jsp">Listado de Precio de Proveedores</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionlistado.php", //Request send to "action.php page"
