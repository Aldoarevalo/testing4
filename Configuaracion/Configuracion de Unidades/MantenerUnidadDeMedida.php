...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
	   ...
	   <li><a href="CrearUnidadDeMedida.php">Crear Unidad de Medida</a></li>
...
<!--		     <li>		<a  href="javascript:Clickheretoprint()" style="font-size:20px;"><button  class="btn btn-success btn-large"><i class="icon-print"></i> Imprimir</button></a></li>-->
       ...
       <h3><a style="color: black" href="MantenerUnidadDeMedida.php"></a>Unidades de Medidaas</h3>
     
        <form id="getaction">
            
            <h4><a style="color: black;text-decoration: none;" >Unidades de Medidas</a></h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionum.php", //Request send to "action.php page"
