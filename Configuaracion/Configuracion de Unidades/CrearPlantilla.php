...
<html>
       <head>
        ...
        <a href=></a>
     <title>Crear Plantilla de Productos</title>
    <meta charset="utf-8">
...
//});
    ...
    <body id="hhmenu">
     ...
     <ul id="hmenu"> 
		...
		<li><a href="MantenerFormula.php">Mantener Plantilla de Productos</a></li>
		
	
</div>
        
        
            <h3  ><a style="color: black;" href="Transferencias.jsp">Crear Plantilla</a></h3>    
...
<label id="labelgeneral">Nombre de Plantilla Nueva</label>
       <input id="txtnombrecategoria" type="text" name="nombreplantilla" value="" />
     ...
     <?php echo $producto; ?>
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input type="submit" name="crear_plantilla" id="crear_plantilla" class="btn btn-info" value="Gravar" />
                </td>
