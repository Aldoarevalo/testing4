...
<body id="hhmenu">
  ...
  <div id="header">
         ...
         <form method="post"action="actionciudad.php">
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                           ...
                           <td style="margin-left:100px;"><a href="EditarCiudad.php?updatep=1&ciudad='.$row["codigociudad"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigociudad" id="codigociudad <?php echo $m; ?>" value="<?php echo $row["codigociudad"]; ?>" />
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>Codigo :</b>
                        ...
                        <b>  </b><b ><?php echo $row['codigociudad']; ?></b><br />
