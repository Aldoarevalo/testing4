...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
		...
		<li><a href="CrearSucursal.php">Crear Sucursal</a></li>
		
	
	
</div>
       <h3 style="color: black">Sucursales</h3>
     
        <form id="getaction">
            
            <h4 style="color: black">Sucursales</h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionsucursal.php", //Request send to "action.php page"
