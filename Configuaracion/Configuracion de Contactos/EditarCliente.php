...
/*                                font-weight:  bold;*/
      ...
      elseif(isset($_GET["updatep"]) && isset($_GET["cliente"]))
      {
include('../../database_connection.php');
...
<!--		<li><a href="crearempleado.jsp">Crear Proveedor</a></li>-->
		<li><a href="MantenerCliente.php">Mantener Cliete</a></li>
              ...
              <div>
                ...
                <input type="hidden" name="accion" value="grabarproveedor" />
                  ...
                  <label id="labelsimbolo">Ruc de Cliente</label>
                   <input id="txtsimbolo"type="text" name="txtruc" value="<?php echo $row["Ci_cliente"]; ?>"/>
                     <span class="help-block" id="error"></span>
                     </div>
                   <div class="form-group">
                     <label id="labelprecioventa">Nombre de Cliente</label>
                     <input id="txtprecioventa" type="text" name="txtnomcli" value="<?php echo $row["clinombres"]; ?>" />
                          <span class="help-block" id="error"></span>
                        </div>
                <div class="form-group">
                       <label id="labelpreciocompra">Telefono</label>
                         <input id="txtpreciocompra" type="text" name="txttelefono" value="<?php echo $row["Telefono"]; ?>" />
                                <div class="form-group">
...
<!--                          <label id="labelpreciocompra">Timbrado</label>
           ...
           <select  id="combosubrubros"  name="combopais"> 
            ...
            <?php echo $pais; ?>
                  ...
                  <input id="gravarmoneda" type="submit" value="Grabar" name="editarcliente" />
        </form>
