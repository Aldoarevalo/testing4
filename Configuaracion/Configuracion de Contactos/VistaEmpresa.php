...
<body id="hhmenu">
  ...
  <div id="header">
         ...
         <form method="post"action="actionempresa.php">
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                           ...
                           <td style="margin-left:100px;"><a href="EditarEmpresa.php?updatep=1&empresa='.$row["cod_emp"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="cod_emp" id="cod_emp <?php echo $m; ?>" value="<?php echo $row["cod_emp"]; ?>" />
...
<?php
					$cod_emp=$_GET['empresa'];
include('../../database_connection.php');
$statement = $connect->prepare(" SELECT * from empresa 
     WHERE cod_emp =:empresa
            LIMIT 1
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>Id :</b>
                        ...
                        <b>  </b><b ><?php echo $row['cod_emp']; ?></b><br />
                    ...
                    <div class="col-md-8">
                     <br /> <b>Empresa :</b>
                       ...
                       <div class="col-md-8">
                     <br /> <b>Ruc :</b>
                        <b>  </b><b><?php echo $row['rucempresa']; ?></b><br />
