...
/*                                font-weight:  bold;*/
   ...
   <body id="hhmenu"> 
    ...
    <div id="header">
		...
		<li><a href="CrearEmpresa.php">Crear Empresa</a></li>
		
	
	
</div>
       <h3 style="color: black">Empresas</h3>
     
        <form id="getaction">
            
            <h4 style="color: black">Empresas</h4>
...
$(document).ready(function(){
 ...
 function fetchUser() // This function will fetch data from table and display under <div id="result">
 {
  var action = "Load";
  $.ajax({
   url : "actionempresa.php", //Request send to "action.php page"
