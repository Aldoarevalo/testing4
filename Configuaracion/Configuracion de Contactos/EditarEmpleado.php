...
/*                                font-weight:  bold;*/
      ...
      elseif(isset($_GET["updatep"]) && isset($_GET["empleado"]))
      {
include('../../database_connection.php');
    ...
    <body id="hhmenu">
     ...
     <div id="header">
		...
		<li><a href="MantenerEmpleado.php">Mantener Empleado</a></li>
         ...
         <h6 id="h6" style="color: black">Crear Empleado</h6>    
        <form method="post"  action="actionempleado.php" id="getmoneda" name ="getmoneda"  class="formularioTipo1">
                <h1 id="h1" style="color: black">Crear Empleado</a></h1>    
                      
            
         
                <input type="hidden" name="accion" value="crear_emp" />
               
                         
       
                  <div class="form-group">
                  <label id="labelsimbolo">Ci</label>
                   <input id="txtsimbolo"type="text" name="txtci" value="<?php echo $row["ciemp"]; ?>" />
                     <span class="help-block" id="error"></span>
                     </div>
                   <div class="form-group">
                     <label id="labelprecioventa">Nombres y apellidos</label>
                     <input id="txtprecioventa" type="text" name="txtnomemple" value="<?php echo $row["nombres"]; ?>" />
                          <span class="help-block" id="error"></span>
                        </div>
                <div class="form-group">
                       <label id="labelpreciocompra">Telefono</label>
                         <input id="txtpreciocompra" type="text" name="txttelefono"value="<?php echo $row["nrtelefono"]; ?>" />
                                <div class="form-group">
                         <label id="labelpreciocompra">Direccion</label>
                         <input id="txtpreciocompra" type="text" name="txtdireccion" value="<?php echo $row["direccion"]; ?>" />
                          <span class="help-block" id="error"></span>
                        </div>
        ...
        <label id="labelsubrubro">Sucursal</label>
           <select  id="combosubrubros"  name="combosuc"> 
            ...
            <?php echo $suc; ?>
               ...
               <input type="hidden" name="codigoempleado" id="codigoempleado  <?php echo $m; ?>" value="<?php echo $row["codigoempleado"]; ?>" />
                  <input id="gravarmoneda" type="submit" value="Grabar" name="editarempleado" />
        </form>
