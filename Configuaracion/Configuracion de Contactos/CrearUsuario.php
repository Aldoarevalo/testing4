    ...
    <body id="hhmenu">
     ...
     <div id="header">
		...
		<li><a href="MantenerUsuario.php">Mantener Usuario</a></li>
         ...
         <h6 id="h6" style="color: black">Crear Usuario</h6>    
       <form method="post" action="actionusuario.php" id="getform">
                <h1 id="h1" style="color: black">Crear Usuario</h1> 
                      
             <div>
         
                <input type="hidden" name="accion" value="crear_user" />
               
                         
       
                
                  <label id="labelgeneral">Nombre</label>
                   <input id="txtsimbolo"type="text" name="txtnombreuser" value="" />
                     <label id="labelgeneral">Tipo de Usuario</label>
                     <select  id="combosubrubros"  name="combotipouser"> 
                       ...
                       <label id="labelizquierda1">Logging</label>
                         <input id="txtizquierza" type="text" name="txtloggin" value="" />
                         <label id="labelizquierda">Paswor</label>
                         <input id="txtizquierza1" type="text" name="txtpaswor" value="" />
             ...
             <?php echo $sucursal; ?>
                            ...
                            <input id="gravar" type="submit" value="Grabar" name="crear_user" />
