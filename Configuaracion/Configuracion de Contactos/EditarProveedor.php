...
/*                                font-weight:  bold;*/
      ...
      elseif(isset($_GET["updatep"]) && isset($_GET["proveedor"]))
      {
include('../../database_connection.php');
  ...
  margin-bottom: 70px;
    ...
    <body id="hhmenu">
     ...
     <div id="header">
		...
		<li><a href="Configuracion/Productos.jsp">Mantener Proveedor</a></li>
		
	
	
</div>
     
         <h6 id="h6" style="color: black">Crear Proveedor</h6>    
        <form method="post"  action="actionproveedor.php" id="getmoneda" name ="getmoneda"  class="formularioTipo1">
                <h1 id="h1" style="color: black">Crear Proveedor</a></h1>    
              ...
              <div>
                ...
                <input type="hidden" name="accion" value="grabarproveedor" />
                  ...
                  <label id="labelsimbolo">Ruc</label>
                   <input id="txtsimbolo"type="text" name="txtruc" value="<?php echo $row["RucProveedor"]; ?>"  placeholder="Ingrese un Ruc Para el proveedor"  />
                     <span class="help-block" id="error"></span>
                     </div>
                   <div class="form-group">
                     <label id="labelprecioventa">Nombre de Proveedor</label>
                     <input id="txtprecioventa" type="text" name="txtnomprovee" value="<?php echo $row["nombreprov"]; ?>"  placeholder="Ingrese un Nombre para el proveedor"  />
                          <span class="help-block" id="error"></span>
                        </div>
                <div class="form-group">
                       <label id="labelpreciocompra">Telefono</label>
                         <input id="txtpreciocompra" type="text" name="txttelefono" value="<?php echo $row["nrtelefono"]; ?>"   placeholder="Ingrese un numero de telefono para el proveedor" />
                                <div class="form-group">
                         <label id="labelpreciocompra">Direccion</label>
                         <input id="txtpreciocompra" type="text" name="txtdireccion" value="<?php echo $row["direccion"]; ?>"  placeholder="Ingrese una direccion para el proveedor"  />
                          <span class="help-block" id="error"></span>
                        </div>
                          <label id="labelpreciocompra">Timbrado</label>
                         <input class="col-md-12" id="txtpreciocompra" type="text" name="txttimbrado" value="<?php echo $row["timbrado"]; ?>"  placeholder="Ingrese un timbrado para el proveedor" />
           ...
           <select  id="combosubrubros"  name="combopais"> 
            ...
            <?php echo $pais; ?>
                ...
                <input type="hidden" name="id" id="id <?php echo $m; ?>" value="<?php echo $row["id"]; ?>" />
                            <input id="gravarimpuesto" type="submit" value="Grabar" name="updateprov" class="btn-info"/> 
            </div>
