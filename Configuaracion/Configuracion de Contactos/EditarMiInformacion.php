...
WHERE  idusuario=:idusuario
    ...
    <body id="hhmenu">
      ...
      <li></li>
        ...
        <h6 id="h6" style="color: black">Editar Mi Informacion Personal</h6>    
        <form method="post" action="actionusuario.php" id="getform">
                <h1 id="h1" style="color: black">Editar Mi Informacion Personal</h1> 
        ...
        <input type="hidden" name="idusuario" id="idusuario <?php echo $m; ?>" value="<?php echo $row["idusuario"]; ?>" />
                            <input id="gravaremp" type="submit" value="Grabar" name="update1" />
