...
//    $order_total_after_tax = 0;
          $statement = $connect->query("SELECT (max(idcreditodebito)+1)idcreditodebito from creditoydebitocabecera");
           $idcreditodebito = $statement->fetchColumn();
    $statement = $connect->prepare("
      INSERT INTO creditoydebitocabecera 
(idcreditodebito,nrcomprobante,rucempresa,nrfactura,fecha,notas,RucProveedor,tipodecomprobante,id_compra)
VALUES (:idcreditodebito,:comprobante, :empresa, :factura,:fecha,:guardar,:prov,:tipo,:idcompra)
    ");
...
//                     echo 'Data Inserted';  
    $statement->execute(
      array(
           ':idcreditodebito'               =>  $idcreditodebito,
...
//        $order_total_after_tax = $order_total_after_tax + floatval(trim($_POST["order_item_final_amount"][$count]));
        ...
        $statement = $connect->prepare("
          INSERT INTO creditoydebitodetalle
          (idcreditodebito,codigoproducto,preciounitario,cantidad,fecha,codigoalmacen)
          VALUES (:idcreditodebito, :item_cod,:order_item_price,:order_item_quantity,:fecha,:almacen)
        ");
...
//      );
//      
      header("location:VistaCreditoDebitoCompra.php?idcreditodebito=$idcreditodebito");
