...
<title>
Vista Nota de Credito y Debito de Compra
</title>
...
<body id="hhmenu">
	...
	<li class=""><a href="Registrar Transferencia.jsp">Informes de Movimientos de Stock</a></li>
		<li><?php
					$idcreditodebito=$_GET['idcreditodebito'];
                                       
include('../database_connection.php');
$statement = $connect->prepare("
          SELECT * FROM VistaNotaCreditoDebitoCompra
             WHERE idcreditodebito = :idcreditodebito
            LIMIT 1
        ");
        $statement->execute(
          array(
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["idcreditodebito"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigoproducto" id="codigoproducto <?php echo $m; ?>" value="<?php echo $row["idcreditodebito"]; ?>" />
...
$statement = $connect->prepare("
        ...
        foreach($result as $row){
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>ID :</b>
                        <b>  </b><b><?php echo $row['idcreditodebito']; ?></b><br />
                    ...
                    <div class="col-md-8">
                     <br /> <b>Empresa :</b>
                        <b>  </b><b><?php echo $row['empresa']; ?></b><br />
                                        ...
                                        <div class="col-md-8">
                     <br /> <b>Numero de Comprobante:</b>
                        <b>  </b><b><?php echo $row['nrcomprobante']; ?></b><br />
...
$statement = $connect->prepare("
        ...
        $item_result = $statement->fetchAll();
				...
				<tr style="font-family:arial; font-size:15px;"  >
                      ...
                      <td><?php echo $sub_row["preciounitario"]; ?></td>
                      <td><?php echo $sub_row["nombres"]; ?></td>
                       <td><?php echo $sub_row["total"]; ?></td>
                      <td><?php echo $sub_row["iva5"]; ?></td>
                      <td><?php echo $sub_row["iva10"];?></td>
                      <td><?php echo $sub_row["nrfactura"];?></td>
				...
				?>
                                        ...
                                        <tr>
                                        <td  colspan="6" style=" text-align:right;"><strong    style="font-size: 12px;">Monto Total: &nbsp;</strong></td>
					<td colspan="2"><strong style="font-size: 12px;"><?php  echo $sub_row["totalp"]; ?>
					</strong></td>
                                        </tr>
				   <tr>
                                        <td  colspan="6" style=" text-align:right;"><strong    style="font-size: 12px;">Numero de Factura de Compra: &nbsp;</strong></td>
					<td colspan="2"><strong style="font-size: 12px;"><?php  echo $sub_row["nrfactura"]; ?>
					</strong></td>
                                        </tr>
