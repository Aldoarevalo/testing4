...
<body  >
 ...
 <fieldset>
	...
	<p   class="validateTips">
        ...
        <div style="width: 1325 px;"  id="menu-wrapper">
     ...
     <ul id="hmenu"> 
        ...
        <div id="menu"style="height:85% ">
	
		<li><a href="RegistrarMoneda.jsp">Crear Moneda</a></li>
		<li><a href="Monedas.jsp">Listar Monedas</a></li>
                
</div>
        </p>
        <h3 style="color: black">Monedas</h3>
	 <form st method="post" action="Controlador" id="getmoneda">
	 <h4><a style="color: black" href="Monedas.jsp">Listar Monedas</a></h4>
       <a id="print" href="http://192.168.1.250:8888/purchase_orders?print=1" class="printer" target="_blank">Imprimir</a>
		...
		<input type="hidden" name="accion" value="registrarmon" />
                                             <label id="labelnombremoneda">Nombre</label>
                 <input id="txtnombremoneda" type="text" name="txtNombre" value="" />
                  <label id="labelsimbolo">Simbolo</label>
                   <input id="txtsimbolo"type="text" name="txtsim" value="" />
                     <label id="labelprecioventa">Precio de Compra</label>
                     <input id="txtprecioventa" type="text" name="txtPrecio" value="0" />
                       <label id="labelpreciocompra">Precio de Venta</label>
                         <input id="txtpreciocompra" type="text" name="txtPrecio1" value="0" />
                       	
	
            <input id="gravarmoneda" type="submit" value="ACEPTAR" />		  
	</form>
    </fieldset>
    ...
    <a  id="create-user">Create new user</a>
