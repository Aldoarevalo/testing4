...
<body id="hhmenu">
	...
	<li class=""><a href="Registrar Transferencia.jsp">Registrar Peido de Compras</a></li>
		<li><?php
					$invoice=$_GET['presupuesto'];
include('database_connection.php');
$statement = $connect->prepare("
          SELECT * FROM presupuestocabecera
             WHERE idPresupuesto = :presupuesto
            LIMIT 1
        ");
        $statement->execute(
          array(
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["idPresupuesto"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigoproducto" id="codigoproducto <?php echo $m; ?>" value="<?php echo $row["idpresupuesto"]; ?>" />
...
$statement = $connect->prepare("
        ...
        foreach($result as $row){
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>ID :</b>
                        <b>  </b><b><?php echo $row['idPresupuesto']; ?></b><br />
                    ...
                    <div class="col-md-8">
                     <br /> <b>Fecha :</b>
                        <b>  </b><b><?php echo $row['Fecha']; ?></b><br />
                                        ...
                                        <div class="col-md-8">
                     <br /> <b>Vencimiento:</b>
                        <b>  </b><b><?php echo $row['Vencimiento']; ?></b><br />
...
include('database_connection.php');
$statement = $connect->prepare("
          SELECT  p.producto,d.idpresupuesto,d.codigoproducto,d.cantidad,d.precio,(d.cantidad*d.precio) AS total
           
            FROM productos p,presupuestodetalle d WHERE p.codigoproducto=d.codigoproducto AND idpresupuesto=:presupuesto
        ");
        $statement->execute(
          array(
            ':presupuesto'       =>  $_GET["presupuesto"]
        ...
        $item_result = $statement->fetchAll();
				...
				?>
					...
					<td colspan="2"><strong style="font-size: 12px;"><?php  echo $sub_row["total"]; ?>
					</strong></td>
                                        </tr>
