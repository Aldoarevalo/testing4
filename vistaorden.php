...
$statement = $connect->prepare("
          SELECT * FROM ordencompracabecera
             WHERE idordencompra = :orden
            LIMIT 1
        ");
        $statement->execute(
          array(
        ...
        foreach($result as $row){
            ...
            echo '
              <tr>
                ...
                <td style="margin-left:100px;"><a href="EditarPedidoCompras.php?update1=1&idpedidocompra='.$row["idordencompra"].'"><span class="btn btn-success btn-large"><i class="icon-print"></i>Editar</span></a></td>
            ...
            ';
				...
				?>		</li>
		<li>  <input type="hidden" name="codigoproducto" id="codigoproducto <?php echo $m; ?>" value="<?php echo $row["idordencompra"]; ?>" />
...
$statement = $connect->prepare("
        ...
        foreach($result as $row){
				...
				<tr class="record">
                    ...
                    <div class="col-md-8">
                      <br /> <b>ID :</b>
                        <b>  </b><b><?php echo $row['idordencompra']; ?></b><br />
...
include('database_connection.php');
$statement = $connect->prepare("
           SELECT  p.producto,d.idordencompra,d.codigoproducto,d.cantidad,d.precio,(d.cantidad*d.precio) AS total
           
            FROM productos p,ordencompradetalle d WHERE p.codigoproducto=d.codigoproducto AND idordencompra=:orden
